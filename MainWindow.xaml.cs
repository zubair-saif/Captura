    ...
    public partial class MainWindow : Window
    {
        ...
        void StartRecording()
        {
            ...
            string Extension = SelectedVideoSourceKind == VideoSourceKind.NoVideo
                ...
                : (Encoder == VideoSettings.GifEncoderKey ? ".gif" : ".avi");
            ...
            Func<bool> IncludeCursorLambda = () => OtherSettings.IncludeCursor;
            ...
            if (SelectedVideoSourceKind == VideoSourceKind.Window)
            {
                ...
                if (Src.Handle == RegionSelector.Instance.Handle && OtherSettings.StaticRegionCapture)
                {
            ...
            if (Encoder == VideoSettings.GifEncoderKey)
            {
            ...
            Recorder.Error += (E) => Dispatcher.Invoke(() =>
            {
                OnStopped();
        ...
        void OnStopped()
        {
            ...
            Status.Content = "Video Saved to Disk";
